...
def convert_lines_to_paragraphs(linelist):
    ...
    # paragraph=''
    #  for ind in range(len(linelist)):
    #      if len(linelist)==0 or .......:
    #         paragraph= paragraph+ ''
    #         list1=list1.append(paragraph)
    #      
    #      elif linelist[ind]=='\n':
    #          paragraph=paragraph+linelist[:ind]
    #          convert_lines_to_string2(paragraph)
    #          list1=list1.append(paragraph)
    #  return list1
    list1=[]
    ...
    #     stringss=[]
    #     if len(linelist)==0:
    #         stringss=stringss.append('')
    #     
    #     elif line.find('\n')==-1:
    #         stringss=stringss.append(line)
    #         print(stringss)
    #     elif line.find('\n')>= 0:
    #         stringss=stringss.append(line[:line.find('\n')
    #     
    #     # elif:
    #     #     stringss
    #     paragraph= convert_lines_to_string2(stringss)   
    #     
